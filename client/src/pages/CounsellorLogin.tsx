...
import { AlertCircle, User, Lock, UserCheck } from 'lucide-react';
...
export default function CounsellorLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Call the backend API to authenticate the counsellor
      const response = await fetch('http://localhost:3001/api/login/counsellor', {
        method: 'POST',
        headers: {
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-gray-700">Professional Email</Label>
