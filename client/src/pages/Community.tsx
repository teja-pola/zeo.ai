...
const Community: React.FC = () => {
  ...
  const chatUsers = [
    {
      id: 1,
      name: "Sarah Johnson",
      avatar: "https://images.unsplash.com/photo-1581382575275-97901c2635b7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8bWFufGVufDB8fDB8fHww",
      online: true,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zeo-surface via-background to-zeo-surface flex">
      ...
      {/* Main Content Area */}
      <div className="ml-[15%] flex-1 flex">
        {/* Chat Panel */}
            ...
            <div className="flex space-x-3">
              ...
              <div className="flex-1">
                <textarea
                  ...
                  className="w-full p-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-zeo-primary/30 focus:border-zeo-primary resize-none text-base leading-relaxed"
                  rows={2}
                />
                <div className="flex items-center justify-between mt-1">
                  ...
                  <button
                    ...
                    className="px-6 py-1.5 bg-[#3E5D32] text-white rounded-full text-sm font-bold hover:from-[#3E5D32] hover:to-[#4CAF50] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-105"
                  >
                    Post
                  </button>
                </div>
        ...
        {/* Right Sidebar */}
        <div className="w-85 p-4 space-y-4 flex-shrink-0">
          {/* Search Box - Smaller */}
